...
with sidebar:
    ...
    # Process inputs into data frames matching the trained model dimensions
...
with main_body:
    ...
    # Create simple, distinct horizontal status columns
    ...
    # Simple Layout Tabs for Data Plots
